...
public class NetworkUtils {
    ...
    public static String getResponseFromHttpUrl(URL url) throws IOException {
        ...
        try {
            ...
            /* Usage of a Scanner starts the data flowing, puts the response into a
               buffer, and converts it from UTF-8 to UTF-16
             */
            Scanner scanner = new Scanner(in);
            // \A stands for :start of a string!, basically creating a single token
